...
from maddpg_IU.trainer.maddpg_cooperative import MADDPGAgentTrainer
...
def parse_args():
    ...
    parser.add_argument("--save-dir", type=str, default="./ten_t6_seed_1/", help="directory in which training state and model should be saved")
    parser.add_argument("--save-rate", type=int, default=1000, help="save model once every time this many episodes are completed")
    parser.add_argument("--load-dir", type=str, default="./ten_t6_seed_1/", help="directory in which training state and model are loaded")
    # Evaluation
    parser.add_argument("--restore", action="store_true", default=False)
    parser.add_argument("--display", action="store_true", default=False)
    parser.add_argument("--plots-dir", type=str, default="./ten_t6_curves_seed_1/", help="directory where plot data is saved")
...
def train(arglist):
    with make_session():
        ...
        while True:
          ...
          #  trainers[curr_index].experience(obs_n[curr_index], action_n[curr_index], rew_n[curr_index], new_obs_n[curr_index], done_n[curr_index])
            # collect experience
            obs_n = new_obs_n
